...
void facture::creerfichier(fstream & ftarifs)
{
    ftarifs("C:\\Users\\ayach\\OneDrive\\Bureau\projet application desktop cyber cafe\\cybercafe\\fichier\\tarif.txt", ios:in |ios:out |ios:app );
    if (!ftarifs.is_open())exit(-1);
}
void facture::remplirfichier(fstream & ftarifs)
{

}
void facture::lecturefichier(fstream & ftarifs)
{
...
void facture::supprimer(int code)
{
   ...
   {    cout<<"le compte existe \n";
       ...
       cout << endl <<"la nouvelle facture est  : " ;
       this->afficher();
   }
}
...
{   promotion p;
    ...
    cout<<"donner le pourcentage de la promotion  : ";
    do{
    cin>>x;
    }while (0<x<1);
    p.set_promotion(x);
